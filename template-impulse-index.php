...
<hr />
	...
	<h1><?php if(of_get_option('welcome_text') != NULL){ echo of_get_option('welcome_text');} else echo "Write your welcome headline here. Have fun with the impulse theme." ?></h1></div>
