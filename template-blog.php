...
$query_args = apply_filters( 'impulse_blog_template_query_args', $query_args ); 
...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-head">
			...
			<h1><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'impulse' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php if ( get_the_title() == '' ) { _e( '(No title)', 'impulse' ); } else { the_title(); } ?></a></h1>
			
			</div><!--post-heading end-->
			
			<div class="meta-data">
			
			<?php impulse_posted_on(); ?> <?php _e('in', 'impulse'); ?> <?php the_category(', '); ?> | <?php comments_popup_link( __( 'Leave a comment', 'impulse' ), __( '1 Comment', 'impulse' ), __( '% Comments', 'impulse' ) ); ?>
